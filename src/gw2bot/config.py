...
class Config:
    ...
    # because it is a page with its own audience, and the gold and events
    # pages follow the roster page's lead for the same reason.
    ...
    events_page_role_id: int = DEFAULT_RAFFLE_DRAW_ROLE_ID
