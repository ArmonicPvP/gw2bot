...
| `/settings raffle_excluded_accounts` | unset | Guild Wars 2 account names barred from the raffle, separated by commas (for example `Someone.1234, Another.5678`). Matched case-insensitively. See [Excluding Someone From The Raffle](#excluding-someone-from-the-raffle). |
